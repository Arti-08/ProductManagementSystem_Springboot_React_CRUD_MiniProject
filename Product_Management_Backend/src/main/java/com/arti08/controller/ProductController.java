...
import com.arti08.service.ProductService;
...
public class ProductController {
	...
	//Not needed as already have edit Product
	//@PostMapping("/editProductById/{id}")
	//public ResponseEntity<?> editProductById(@RequestBody Product product, @PathVariable Integer id) {
